...
all_data=read.table("all_data_imputation_sensitive.txt",header = T)
...
RF1=data.frame(Exposure="eGFR_scr_10",R2=R1, F=F1)
#eGFR_scys
...
RF2=data.frame(Exposure="eGFR_scys_10",R2=R2, F=F2)
#BUN
...
samples=data.frame(exposure=c("eGFR_scr_10","eGFR_scys_10","BUN"),samples=c(sample1,sample2,sample3))
...
scr_allinfection = data.frame(Exposure="eGFR_scr_10", Outcome="all_infections",MR_causal_effect = MR_CE,
...
scr_pneumonia = data.frame(Exposure="eGFR_scr_10", Outcome="pneumonia",MR_causal_effect = MR_CE,
                           MR_SE = MR_SE, MR_HR = MR_HR, MR_HR_lower95=MR_HR_lower95,MR_HR_upper95=MR_HR_upper95,
                           MR_pvalue=MR_pvalue,samples=samples,events=events)
...
scr_sepsis = data.frame(Exposure="eGFR_scr_10", Outcome="sepsis",MR_causal_effect = MR_CE,
                        MR_SE = MR_SE, MR_HR = MR_HR, MR_HR_lower95=MR_HR_lower95,MR_HR_upper95=MR_HR_upper95,
                        MR_pvalue=MR_pvalue,samples=samples,events=events)
...
scr_skin_soft_tissue = data.frame(Exposure="eGFR_scr_10", Outcome="skin_soft_tissue",MR_causal_effect = MR_CE,
                                  MR_SE = MR_SE, MR_HR = MR_HR, MR_HR_lower95=MR_HR_lower95,MR_HR_upper95=MR_HR_upper95,
                                  MR_pvalue=MR_pvalue,samples=samples,events=events)
...
scr_urinary_tract = data.frame(Exposure="eGFR_scr_10", Outcome="urinary_tract",MR_causal_effect = MR_CE,
                               MR_SE = MR_SE, MR_HR = MR_HR, MR_HR_lower95=MR_HR_lower95,MR_HR_upper95=MR_HR_upper95,
                               MR_pvalue=MR_pvalue,samples=samples,events=events)
...
scys_allinfection = data.frame(Exposure="eGFR_scys_10", Outcome="all_infections",MR_causal_effect = MR_CE,
                               MR_SE = MR_SE, MR_HR = MR_HR, MR_HR_lower95=MR_HR_lower95,MR_HR_upper95=MR_HR_upper95,
                               MR_pvalue=MR_pvalue,samples=samples,events=events)
...
scys_pneumonia = data.frame(Exposure="eGFR_scys_10", Outcome="pneumonia",MR_causal_effect = MR_CE,
                            MR_SE = MR_SE, MR_HR = MR_HR, MR_HR_lower95=MR_HR_lower95,MR_HR_upper95=MR_HR_upper95,
                            MR_pvalue=MR_pvalue,samples=samples,events=events)
...
scys_sepsis = data.frame(Exposure="eGFR_scys_10", Outcome="sepsis",MR_causal_effect = MR_CE,
                         MR_SE = MR_SE, MR_HR = MR_HR, MR_HR_lower95=MR_HR_lower95,MR_HR_upper95=MR_HR_upper95,
                         MR_pvalue=MR_pvalue,samples=samples,events=events)
...
scys_skin_soft_tissue = data.frame(Exposure="eGFR_scys_10", Outcome="skin_soft_tissue",MR_causal_effect = MR_CE,
                                   MR_SE = MR_SE, MR_HR = MR_HR, MR_HR_lower95=MR_HR_lower95,MR_HR_upper95=MR_HR_upper95,
                                   MR_pvalue=MR_pvalue,samples=samples,events=events)
...
scys_urinary_tract = data.frame(Exposure="eGFR_scys_10", Outcome="urinary_tract",MR_causal_effect = MR_CE,
                                MR_SE = MR_SE, MR_HR = MR_HR, MR_HR_lower95=MR_HR_lower95,MR_HR_upper95=MR_HR_upper95,
                                MR_pvalue=MR_pvalue,samples=samples,events=events)
...
MR_result=rbind(scr_allinfection,scr_pneumonia,scr_sepsis,scr_skin_soft_tissue,scr_urinary_tract,
                scys_allinfection,scys_pneumonia,scys_sepsis,scys_skin_soft_tissue,scys_urinary_tract,
                BUN_allinfection,BUN_pneumonia,BUN_sepsis,BUN_skin_soft_tissue,BUN_urinary_tract)

write.csv(RF,"RF_sensitive.csv")
write.csv(MR_result,"linear_MR_result_sensitive.csv")
...
pdf("Nonlinear_MR_sensitive.pdf",family = "Times",height = 20,width = 15)
...
RF=rbind(RF1,RF2,RF3)
write.csv(RF,"RF_252_sensitive.csv")
...
linear_MR_result = data.frame(exposure=c("eGFR_cr_10","eGFR_cr_10","eGFR_cr_10","eGFR_cr_10","eGFR_cr_10",
                                         "eGFR_cys_10","eGFR_cys_10","eGFR_cys_10","eGFR_cys_10","eGFR_cys_10",
                                         "BUN","BUN","BUN","BUN","BUN"),
...
write.csv(linear_MR_result_df,"linear_MR_252SNP_sensitive.csv")
...
pdf("Nonlinear_MR_252SNP_sensitive.pdf",family = "Times",height = 20,width = 15)
